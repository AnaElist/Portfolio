...
## Цель проекта
Цель выполнения проекта – отработка навыков работы с объединением данных из разных таблиц (JOIN) и их последующего анализа. Проект выполнен в рамках прохождения курсов аналитики данных Karpov.courses.
...
**4.** Самое время посмотреть на общую выручку, а также минимальный, максимальный и средний чек. Рассчитайте нужные показатели.
